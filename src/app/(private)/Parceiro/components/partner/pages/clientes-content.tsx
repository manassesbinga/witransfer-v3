...
import { Users, Download, Plus, Eye, Edit, Ban, Trash2, Star, List, LayoutGrid, Filter, X } from "lucide-react"
...
const clientes = [
  {
    ...
    nome: "Ana Pereira",
    email: "ana@email.com",
    telefone: "+244 924 111222",
    viagens: 34,
    avaliacao: 4.3,
    status: "ativo",
    dataCadastro: "05/11/2023",
  },
  {
    id: 2,
    nome: "Carlos Silva",
    email: "carlos@email.com",
    telefone: "+244 923 456789",
    viagens: 56,
    avaliacao: 4.6,
    status: "ativo",
  ...
  },
  {
    ...
    telefone: "+244 922 222333",
    viagens: 12,
    avaliacao: 4.1,
    status: "inativo",
    dataCadastro: "19/08/2023",
  },
  {
    id: 4,
    nome: "Maria Santos",
    email: "maria@email.com",
    telefone: "+244 912 345678",
    viagens: 28,
    avaliacao: 4.8,
    status: "ativo",
  ...
  },
  {
    ...
    telefone: "+244 934 567890",
    viagens: 8,
    avaliacao: 3.9,
    status: "suspenso",
    dataCadastro: "25/09/2023",
  },
]
...
export function ClientesContent() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "ativo":
        return <span className="text-green-600 font-medium">ativo</span>
      case "inativo":
        return <span className="text-gray-500 font-medium">inativo</span>
      case "suspenso":
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-blue-600 mt-1">Gerencie todos os clientes cadastrados</p>
          </div>
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent>
                ...
                <div className="space-y-4 py-4">
                  ...
                  <Button className="w-full bg-blue-600 hover:bg-blue-700">Cadastrar Cliente</Button>
                </div>
              </DialogContent>
            </Dialog>
          </div>
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredClientes.map((cliente) => (
                <tr key={cliente.id} className="hover:bg-blue-50 transition-colors">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-1 text-sm text-gray-500">
                          <span>{cliente.avaliacao}</span>
                          <Star className="h-3 w-3 fill-amber-400 text-amber-400" />
                        </div>
                      </div>
                    </div>
                  </td>
                  {cols.email && <td className="px-6 py-4 text-gray-600">{cliente.email}</td>}
                  {cols.telefone && <td className="px-6 py-4 text-gray-600">{cliente.telefone}</td>}
                  {cols.viagens && (
                  ...
                  {cols.status && <td className="px-6 py-4">{getStatusBadge(cliente.status)}</td>}
                  {cols.dataCadastro && <td className="px-6 py-4 text-gray-600">{cliente.dataCadastro}</td>}
                  <td className="px-6 py-4">
