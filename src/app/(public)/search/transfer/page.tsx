...
export default async function TransferSearchPage({
  ...
  if (draftId) {
    try {
      ...
      console.warn("Failed to load draft in transfer search page:", err);
    }
  }
  ...
  try {
    ...
    console.error("Server-side search failed in Transfer Page:", e);
  }
  */
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-64px)]">
      <div className="bg-[#003580] shadow-md pb-4 pt-4  border-none">
