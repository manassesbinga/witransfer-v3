      ...
      <div className="sticky top-0 z-30 bg-white border-b border-gray-100 shadow-sm mb-4">
        <div className="flex flex-col gap-2 py-3 px-4">
          ...
          <div className="flex items-center justify-between gap-4 w-full">
            <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide py-1 -mx-4 px-4 w-full">
              {categoriesData.map((cat) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "inline-flex items-center gap-1.5 py-1.5 px-3 transition-all rounded-full border whitespace-nowrap",
                      isSelected
                  ...
                  >
                    ...
                    >
                      {cat.label} <span className="opacity-70 ml-0.5 text-[9px]">({count})</span>
                    </span>
                  </button>
                );
              })}
